...
public class DataSeederResep implements CommandLineRunner {
    ...
    public List<ResepModel> seedDummyData() {
        ...
        ResepModel r1 = new ResepModel("101", null, null, null, null, "Siti Rahma", "3x1 sesudah makan", 25000.0, null);
        r1.catatKeluhan("Sakit Gigi Melubang & Gigi Sensitif");
        r1.tambahResep(1L, "Paracetamol", 2);
        r1.setTotalHargaObat((double) r1.hitungTotalHargaObat());

        ResepModel r2 = new ResepModel("102", null, null, null, null, "Ahmad Hidayat", "2x1 kumur setelah sikat gigi", 45000.0, null);
        r2.catatKeluhan("Pembersihan Karang Gigi & Gusi Berdarah");
        r2.tambahResep(2L, "Amoxicillin", 1);
        r2.setTotalHargaObat((double) r2.hitungTotalHargaObat());

        ResepModel r3 = new ResepModel("103", null, null, null, null, "Dewi Sartika", "3x1 diminum jika nyeri", 30000.0, null);
        r3.catatKeluhan("Cabut Gigi Bungsu & Pembengkakan Gusi");
        r3.tambahResep(3L, "Ibuprofen", 3);
        r3.setTotalHargaObat((double) r3.hitungTotalHargaObat());

        ResepModel r4 = new ResepModel("104", null, null, null, null, "Rizky Pratama", "1x1 malam sebelum tidur", 60000.0, null);
        r4.catatKeluhan("Pemasangan Behel & Iritasi Mulut");
        r4.tambahResep(4L, "Betadine Kumur", 2);
